          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Choose an Issue Type</label>
                <select class="form-control select2" id="provinces" name="provinces" style="width: 100%;">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="number" name="customer_number" id="customer_number" style="width: 100%;">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"
                         data-inputmask="'mask': ['999-999-9999 [99999]', '+234 99 99 9999[9]-9999']" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
